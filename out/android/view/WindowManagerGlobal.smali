...
.method public addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;Landroid/view/Display;Landroid/view/Window;)V
    ...
    if-lt v8, v10, :cond_af

    iget v8, v7, Landroid/view/WindowManager$LayoutParams;->type:I

    const/16 v10, 0x7cf

    if-gt v8, v10, :cond_af
    ...
    monitor-exit v9
    :try_end_ae
    .catchall {:try_start_2f .. :try_end_ae} :catchall_ac
    ...
    monitor-exit v9
    :try_end_cb
    .catchall {:try_start_af .. :try_end_cb} :catchall_ac
    ...
    :try_end_ce
    .catch Ljava/lang/RuntimeException; {:try_start_cb .. :try_end_ce} :catch_cf
