...
.method private findAccessibilityNodeInfoByAccessibilityIdUiThread(Landroid/os/Message;)V
    ...
    invoke-interface {v4}, Ljava/util/List;->clear()V
    :try_end_3d
    .catch Landroid/os/RemoteException; {:try_start_28 .. :try_end_3d} :catch_8f
...
.method private findAccessibilityNodeInfosByTextUiThread(Landroid/os/Message;)V
    ...
    :try_end_5f
    .catch Landroid/os/RemoteException; {:try_start_3e .. :try_end_5f} :catch_141
...
.method private findAccessibilityNodeInfosByViewIdUiThread(Landroid/os/Message;)V
    ...
    iget-object v10, v10, Landroid/view/ViewRootImpl;->mAttachInfo:Landroid/view/View$AttachInfo;
    :try_end_28
    .catchall {:try_start_1e .. :try_end_28} :catchall_a7
    ...
    invoke-interface {v2, v4, v5}, Landroid/view/accessibility/IAccessibilityInteractionConnectionCallback;->setFindAccessibilityNodeInfosResult(Ljava/util/List;I)V
    :try_end_3c
    .catch Landroid/os/RemoteException; {:try_start_2a .. :try_end_3c} :catch_bd
    ...
    :try_end_5a
    .catchall {:try_start_3d .. :try_end_5a} :catchall_a7
    ...
    :try_end_92
    .catchall {:try_start_72 .. :try_end_92} :catchall_a7
    ...
    invoke-interface {v2, v4, v5}, Landroid/view/accessibility/IAccessibilityInteractionConnectionCallback;->setFindAccessibilityNodeInfosResult(Ljava/util/List;I)V
    :try_end_ba
    .catch Landroid/os/RemoteException; {:try_start_a8 .. :try_end_ba} :catch_bb
...
.method private findFocusUiThread(Landroid/os/Message;)V
    ...
    :try_end_46
    .catch Landroid/os/RemoteException; {:try_start_30 .. :try_end_46} :catch_113
...
.method private focusSearchUiThread(Landroid/os/Message;)V
    ...
    :try_end_36
    .catch Landroid/os/RemoteException; {:try_start_24 .. :try_end_36} :catch_87
...
.method private perfromAccessibilityActionUiThread(Landroid/os/Message;)V
    ...
    :try_end_31
    .catch Landroid/os/RemoteException; {:try_start_27 .. :try_end_31} :catch_78
